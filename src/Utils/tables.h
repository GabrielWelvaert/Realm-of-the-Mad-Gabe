...
#define LONGGREENFIREBOLT LOFIOBJ5, {8*11, 8*11, 8, 16}, 32, 32, {4,24}
#define ZSHOT LOFIOBJ4, {8*0, 8*12, 8, 8}, 32, 32, {4,4} 
#define WHITECROSS LOFIOBJ, {8*8,8*8,8,8}, 32,32,{4,4}
#define REDCROSS LOFIOBJ, {8*8,8*9,8,8}, 32,32,{4,4}
#define YELLOWCROSS LOFIOBJ, {8*15,8*12,8,8}, 32,32,{4,4}
#define ICESHOT LOFIOBJ4, {8*2, 8*12,8,8}, 10,10,{14,14}

#define WHITEBOOMERANG LOFIOBJ, {8*3, 8*8,8,8}, 32, 32, {4,4}
#define REDBOOMERANG LOFIOBJ, {8*3, 8*9,8,8}, 32, 32, {4,4}
#define GREENBOOMERANG LOFIOBJ, {8*3, 8*10,8,8}, 32, 32, {4,4}
#define BLUEBOOMERANG LOFIOBJ, {8*3, 8*11,8,8}, 32, 32, {4,4}
#define PURPLEBOOMERANG LOFIOBJ, {8*3, 8*12,8,8}, 32, 32, {4,4}
...
#define BLACKSPINNER LOFIOBJ4, {8*3, 8*8,8,8}, 32,32,{4,4}
#define GREENBALL LOFIOBJ4, {8*7, 8*8,8,8}, 32,32,{4,4}

#define NULL_PEC 0, 0, 0, 0, 0, 0.0f // dont use this if it has secondary projectile!

// in order of how they're written its: boomerang, orbits, rotates, oscillates, ignoredef, inflictSE, diagonal, piercing
...
#define BITS_OSCILLATING_ROTATING 0b00110000
#define BITS_ROTATE_BOOMERANG 0b10100000
#define BITS_OSCILLATING_BOOMERANG 0b10010000
#define BITS_DIAGONAL_INFLICTSE 0b00000110
...
extern std::unordered_set<sprites> healsOther;
