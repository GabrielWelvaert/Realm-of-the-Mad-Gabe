...
class StatSystem: public System{
    private:
        ...
        std::unordered_map<classes, std::array<std::array<char, 2>, 8>> levelUpRanges = {
            ...
            {PRIEST, {{{20,30},{5,15},{1,2},{0,0},{1,2},{0,2},{0,1},{1,2}}}},
            {WARRIOR, {{{20,30},{2,8},{1,2},{0,0},{1,2},{0,2},{1,2},{0,2}}}},
            {KNIGHT, {{{20,30},{2,8},{1,2},{0,0},{1,2},{0,2},{1,2},{0,2}}}},
            {WIZARD, {{{20,30},{5,15},{1,2},{0,0},{1,2},{1,2},{0,1},{0,2}}}},
            {ROGUE, {{{20,30},{2,8},{1,2},{0,0},{1,2},{1,2},{0,2},{0,2}}}},
        };
