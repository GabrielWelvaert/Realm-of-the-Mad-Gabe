...
class StatSystem: public System{
    private:
        ...
        std::unordered_map<classes, std::array<std::array<char, 2>, 8>> levelUpRanges = {
            ...
            {ARCHER, {{{22,30},{3,8},{1,2},{0,0},{1,2},{0,2},{1,1},{1,2}}}}, // for all, hp min used to be 20 (now 22) and mp min used to be 2 (now 3) or 5 (now 7)
            {PRIEST, {{{22,30},{7,15},{1,2},{0,0},{1,2},{0,2},{1,1},{1,2}}}},
            {WARRIOR, {{{22,30},{3,8},{1,2},{0,0},{1,2},{0,2},{1,2},{1,2}}}},
            {KNIGHT, {{{22,30},{3,8},{1,2},{0,1},{1,2},{0,2},{1,2},{1,2}}}},
            {WIZARD, {{{22,30},{7,15},{1,2},{0,0},{1,2},{1,2},{1,1},{1,2}}}},
            {ROGUE, {{{22,30},{3,8},{1,2},{0,0},{1,2},{1,2},{1,2},{1,2}}}},
            {NECROMANCER, {{{22,30},{7,15},{1,2},{0,0},{1,2},{1,2},{1,2},{1,2}}}},
            {PALADIN, {{{22,30},{3,8},{1,2},{0,0},{1,2},{0,2},{1,2},{1,2}}}},
            {SORCERER, {{{22,30},{7,15},{1,2},{0,0},{1,2},{1,2},{1,2},{1,2}}}},
        };
